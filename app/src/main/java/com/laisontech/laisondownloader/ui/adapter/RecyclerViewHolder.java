...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewGroup getViewGroup(int viewId) {
        return (ViewGroup) getView(viewId);
    }
    ...
    public RecyclerViewHolder setVisablePage(int viewId, int recyId) {
        LinearLayout webView = findViewById(viewId);
        LinearLayout recy = findViewById(recyId);
        return this;
    }

    public LinearLayout getLayoutView(int viewId) {
