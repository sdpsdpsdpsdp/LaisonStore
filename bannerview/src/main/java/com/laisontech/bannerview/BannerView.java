...
import com.laisontech.bannerview.transformer.CoverModeTransformer;
import com.laisontech.bannerview.transformer.ScaleYTransformer;
...
public class BannerView<T> extends RelativeLayout {
    ...
    private void init(){
        ...
        mViewPager = (BannerViewPager) view.findViewById(R.id.banner_vp);
